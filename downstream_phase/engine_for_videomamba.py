...
def train_one_epoch(
    ...
    model.train(True)
    metric_logger = utils_mamba.MetricLogger(delimiter="  ")
    metric_logger.add_meter("lr", utils_mamba.SmoothedValue(window_size=1, fmt="{value:.6f}"))
    metric_logger.add_meter("min_lr", utils_mamba.SmoothedValue(window_size=1, fmt="{value:.6f}"))
