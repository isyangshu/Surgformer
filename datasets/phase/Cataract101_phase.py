...
class PhaseDataset_Cataract101(Dataset):
    """Load video phase recognition dataset."""

    def __init__(
        self,
        anno_path="data/Cataract101/labels_pkl/train/1fpstrain.pickle",
        data_path="data/Cataract101",
        mode="train",  # val/test
...
if __name__ == "__main__":
    ...
    data_loader_train = torch.utils.data.DataLoader(dataset, batch_size=1, shuffle=False)
